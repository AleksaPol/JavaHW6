...
вывод подходящих */
   ...
   public class task {
     public static void main(String[] args) {
         Notebook note1 = new Notebook("Lenovo", "AS567", "white", 15.6f, 64, 2, "Windows", 32000);
         Notebook note2 = new Notebook("ASUS", "ML987", "black", 13.6f, 128, 4, "Windows", 28000);
         ...
         Notebook note7 = new Notebook("ASUS", "LI487", "white", 14.4f, 64, 4, "Windows", 25000);
         Notebook note8 = new Notebook("Digma", "AS555","gray", 14.2f, 128, 8, "Linux", 40000);
        ...
        //  printInfo(noteSet);
        System.out.println("Здравстуйте, здесь вы можете отобрать ноутбуки по необходимым критериям! Все имеющиеся ноутбуки представлены ниже:");
        printInfo(noteSet);
        selectNote(noteSet);
     }
